...
from src.model_database.lagllama.evaluate.base_dataset import BaseTestDataset, TestDatasetAttributes
...
class PayrollDataset(BaseTestDataset):
    ...
    def _init_attributes(self) -> TestDatasetAttributes:
        ...
        return TestDatasetAttributes(
            prediction_length=6, context_length=24, available_target_columns=self.available_keys, freq="M", id_var="ID"
        )
