...
from src.dataset_preparation.synthetic.data_convert import dataset_to_numpy

# 1. TimeGAN model
from src.dataset_preparation.synthetic.timegan import timegan
...
poetry run python src/dataset_preparation/synthetic/generate_synthetic.py --data_name sine --seq_len 24
"""
