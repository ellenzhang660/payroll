...
def visualize_forecast(forecast, ts, save_path: str | None =None, prediction_interval=(10, 90)):
    ...
    plt.fill_between(forecast_index, lower, upper, color="green", alpha=0.3,
...
if __name__ == "__main__":
    ...
    llama_forecast = LlamaPredictions(prediction_length=dataset.prediction_length, context_length=dataset.context_length, device=device, use_rope_scaling=True, num_samples=10)
