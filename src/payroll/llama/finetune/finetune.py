...
class FinetuneLagLlama:
    ...
    def finetune(self, train: PandasDataset, valid: PandasDataset):
        ...
        torch.save(self.finetuned_predictor, "lag-llama-models/" + date.today().strftime("%m-%d"))
...
if __name__ == "__main__":
    args = set_args()
    dataset = init_dataset(dataset=args.dataset, mode="train")
    train_dataset = dataset.dataset
    val_dataset = init_dataset(dataset=args.dataset, mode="val").dataset
    ...
    finetune_llama.finetune(train=train_dataset, valid=val_dataset)
